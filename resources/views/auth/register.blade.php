                    ...
                    <div class="form-content">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="text-left">
                            ...
                            <div class="form">
                                ...
                                {!! ($errors->has('email')) ? '<label class="error">'.$errors->first('email').'</label>' : '' !!}
                                
                                <div id="name-field" class="field-wrapper input">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="name" name="name" type="name" value="{{ old('name') }}" placeholder="User name">
                                </div>
                                {!! ($errors->has('name')) ? '<label class="error">'.$errors->first('name').'</label>' : '' !!}
                                ...
                                <div id="confirm-password-field" class="field-wrapper input mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                                    <input id="password_confirmation" name="password_confirmation" type="password" value="{{ old('password_confirmation') }}" placeholder="Confirm Password">
                                </div>
                                ...
                                {!! ($errors->has('agree')) ? '<label class="error">Must agree our terms and conditions</label>' : '' !!}
                      ...
                      <p class="terms-conditions">© 2020 All Rights Reserved. <a href="#">DENONTEK</a></p>
